...
public class UserDO implements Serializable {
	...
	public String toString() {
		return "UserDO [userId=" + userId + ", username=" + username + ", name=" + name + ", password=" + password
				...
				+ ", gmtModified=" + gmtModified + ", roleIds=" + roleIds + ", usertype=" + usertype + ", projectids="
				+ projectids + ", rolesign=" + rolesign + ", sex=" + sex + ", birth=" + birth + ", picId=" + picId
				+ ", liveAddress=" + liveAddress + ", hobby=" + hobby + ", province=" + province + ", city=" + city
				+ ", district=" + district + ", supplier=" + supplier + ", isreset=" + isreset + "]";
	}
}
